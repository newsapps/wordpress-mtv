 ...
 * @since Twenty Eleven 1.0
 */
function twentyeleven_posted_on($post) {
	printf( __( '<span class="sep">Posted on </span><a href="%1$s" title="%2$s" rel="bookmark"><time class="entry-date" datetime="%3$s" pubdate>%4$s</time></a><span class="by-author"> <span class="sep"> by </span> <span class="author vcard"><a class="url fn n" href="%5$s" title="%6$s" rel="author">%7$s</a></span></span>', 'twentyeleven' ),
		esc_url( $post->permalink() ),
		esc_attr( $post->the_time() ),
		esc_attr( $post->the_date('c') ),
		esc_html( $post->the_date() ),
		esc_url( get_author_posts_url( $post->post_author ) ),
		sprintf( esc_attr__( 'View all posts by %s', 'twentyeleven' ), get_the_author_meta('display_name', $post->post_author)),
